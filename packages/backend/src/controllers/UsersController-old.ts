...
//             // body into it. Once again, notice we're not doing any validation at all. Accepting data and attempting
//             //  to coerce it into a UserEntity can cause undefined behaviour! Therefore the spreading of the content
//             // of requestBody is rather risky and it'd be much safer to manually define all properties to update.
//             // However we're lazy and the spread notation is super slick.
